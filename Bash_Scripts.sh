...
bcftools view -s ^Dmel_Samarkand_inbred -Oz -o hel_ho_markers.vcf.gz hel_marker_flt.vcf.gz
bcftools view -s ^Dmel_OregonR_non-inbred -Oz -o hel_hs_markers.vcf.gz hel_marker_flt.vcf.gz
bcftools view -s ^Dmel_OregonR_non-inbred -Oz -o sam_hs_markers.vcf.gz sam_marker_flt.vcf.gz
bcftools view -s ^Dmel_Helsinki_inbred_F11 -Oz -o sam_so_markers.vcf.gz sam_marker_flt.vcf.gz
bcftools view -s ^Dmel_Helsinki_inbred_F11 -Oz -o ore_so_markers.vcf.gz ore_marker_flt.vcf.gz
bcftools view -s ^Dmel_Samarkand_inbred -Oz -o ore_ho_markers.vcf.gz ore_marker_flt.vcf.gz
